...
<div class="form">
  <form method="post">
	...
	Example:<br>
	Our Alumini<br>
    <input type="text" name="aluminigrp" placeholder="Alumini Caption" required><br>
...
?>
	UPLOAD a File jpg file less then 50MB and must be 640x310px:<br>
	<br>

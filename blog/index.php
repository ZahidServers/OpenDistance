...
<link rel="shortcut icon" href="../favicon2.ico" type="image/vnd.microsoft.icon">
<link rel="shortcut icon" type="image/x-icon" href="../favicon2.ico" />
<title><?php include '../sitetitle.php'?>|Blog</title>
...
<body contenteditable="false">
  ...
  <a class="active" href="./" onclick="changeabout()">Blogs</a>
...
$resultf=mysql_query("SELECT *FROM blog WHERE id<'4'");
echo"<h6 style='color:white;padding:10px;'>Here Our our popular blogs you can search more from search above</h6>";

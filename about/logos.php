...
<!DOCTYPE html>
	...
	<body>
		...
		<marquee width="120%" direction="left" height="15px" scrollamount="10" >Announcements:<?php include '../marquee/marquee.txt';?></marquee>
			...
			<form method='get' autocomplete='off' action='../course/' style="float:right;display:inline-block;line-height:52px;padding-right:14px; width:30%;">
				<input class='search' type="text" name="k" placeholder="search.." style="width:70%;box-sizing: border-box;border: 2px solid #ccc;border-radius: 4px;font-size: 16px;background-color: white;background-image: url('searchicon.png');background-position: 10px 10px;background-repeat: no-repeat;padding: 12px 20px 12px 40px;"><input class='search' type="submit" style="width:25%;background-color: #4CAF50;border: none;color: white;padding: 15px 6px;text-decoration: none;margin: 4px 2px;cursor: pointer;" value="Search"></input>
			</form>
		</header>
		</div>
	</body>
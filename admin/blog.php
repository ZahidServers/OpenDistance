...
if ( window.location === window.parent.location ) 
{
  ...
  <script src="../blog/tinymce/tinymce.min.js" referrerpolicy="origin"></script>
  <script src="../blog/tinymce/jquery.min.js"></script>
    ...
    min_height: 350,
	  allow_unsafe_link_target: true,
	    ...
	    extended_valid_elements: 'style[type|src] head script[src|async|defer|type|charset]',
		 content_css: [
    '../blog/font-awesome.min.css',
	'../blog/roboto.css',
    '../blog/w3.css',
    '../blog/defaultcompanydescription.css',
	'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css',
	],
	templates : [
    {
      title: "Job Resume",
	  content:"<head><meta charset='UTF-8'><meta name='viewport' content='width=device-width, initial-scale=1'><link rel='stylesheet' href='../w3.css'><link rel='stylesheet' href='../roboto.css'><link rel='stylesheet' href='../font-awesome.min.css'><link rel='stylesheet' href='../blog/w3.css'><link rel='stylesheet' href='../blog/roboto.css'><link rel='stylesheet' href='../blog/font-awesome.min.css'></head>",
      url: "../blog/templates/job1.html",
      description: "An example of how you can create pages for your blog"
    },
	{
      title: "Company Description",
	  content:"<head><meta charset='UTF-8'><meta name='viewport' content='width=device-width, initial-scale=1'><link rel='stylesheet' href='../w3.css'><link rel='stylesheet' href='../roboto.css'><link rel='stylesheet' href='../font-awesome.min.css'><link rel='stylesheet' href='../blog/w3.css'><link rel='stylesheet' href='../blog/roboto.css'><link rel='stylesheet' href='../blog/font-awesome.min.css'></head>",
      url: "../blog/templates/company_description.html",
      description: "An example of how you can create pages for your blog"
    },
	]
  });
...
if($a=="/admin/blog.php")
{echo"
<h1>Create/Edit blog pages</h1>
<h3><a href='./blog.php?create=1'>Click here</a> to create a new page</h3>
<h3><a href='./blog.php?edit=1'>Click here</a> to Edit Existing page</h3>";
}
?>
<?php
	if(isset($_GET['k']))
...
if($numrows>0)
{
	...
	{
		$ist++;
		echo "<h4><a href='./blog.php?update=".$rowz['id']."'>$ist .".$rowsz['title']."</a></h4>";
	}
}
else{
...
$con = mysql_connect($host, $udb, $pass);
	...
	echo"<center>
	<form method='get' action='./blog.php'>
	<input type='text' style='width:250px;' name='k' placeholder='Search For Blog' autocomplete='off'><input type='submit' value='Search'>
	</form></center>";
if(!isset($_GET['k']))
{
	echo "<style>
	...
	mysql_select_db("studentenrollment");
	$query=mysql_query("SELECT *FROM blog WHERE id<6");
	if($query === false){
...
$ist=0;
	...
	{
		$ist++;
		echo "<h4><a href='./blog.php?update=".$rowsz['id']."'>$ist .".$rowsz['title']."</a></h4>";
	}
}
}
?>
...
if (!$con) {
	...
	mysql_select_db("studentenrollment");
	$query=mysql_query("SELECT *FROM blog WHERE id='$updates'");
	while($rowsz=mysql_fetch_array($query))
	{
		$title=$rowsz['title'];
		$link=$rowsz['link'];
	...
	echo"<h4>Update the blog '$title'</h4>";
	if(isset($_POST['fs']))
{
 $fs=$_POST["fs"];
 $titlef=$_POST["title"];
 ...
 if(mysql_query("UPDATE blog SET link='$linker',title='$title',body='$rf' WHERE id='$updates'"))
 {
	...
	echo"<form action='./blog.php?update=1' id='myForm' method='post'>
...
mysql_select_db("studentenrollment",$con);
  $resultf=mysql_query("SELECT *FROM blog");
  $flag=0;
...
{
	$rf=mysql_real_escape_string($fs);
 if(mysql_query("INSERT INTO blog (link,title,body) VALUES('$linker','$title','$rf')"))
 {
	echo"<h1 style='top:0;color:red;background-color:hotpink;'>Sucessfully Database Updated</h1>";
 }
 else{
	echo"<h1 style='top:0;color:red;background-color:hotpink;'>Error:".mysql_error()."</h1>";
		...
		echo"<h1 style='top:0;color:red;background-color:hotpink;'>Error:This Blog Already Exists</h1>";
		$error=1;
}
}
if($error==0){$fs="Design your page design here!!";$title='';}
 echo"<form action='./blog.php?create=1' id='myForm' method='post'>
<table style='width:100%'><tr><th style='width:10%' align='left'>Page Title:</th><td>

...
mysql_select_db("studentenrollment",$con);
 $resultf=mysql_query("SELECT *FROM user WHERE id='$id'");
...
if($gender=='male')
{
 ...
 echo"
<body>
<center><h3>$fnames Details</h3></center>

<table align='center' cellpadding = '10'>
<tr><td>Photo</td><td><div style='vertical-align:top;' class='box'><div style='float:left;'><img src='../user/$idfdr' style='border-radius:50%;' width='100px' height='110px'></div><div>";
  echo  '<form action="./EUD.php?id='.$id.'" enctype="multipart/form-data" accept="image/png" method="post">
Select image :
...
move_uploaded_file($_FILES["file"]["tmp_name"], "../user/".$pname.".".$extension);
$sql="UPDATE user SET photo='$pname.$extension' where id='$id'";
if (mysql_query($sql)) 
{
...
echo"
<form action='r2.php?id=".$id."' method='post'>
</td>
</tr>
<!----- First Name ---------------------------------------------------------->
<tr>

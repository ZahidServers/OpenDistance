...
<div class='nav'><br>&nbsp;"; include'../../sitetitle.php';echo"|Checkout<br><div style='color: #333;'>.</div></div>";?>
			...
			<tbody>
				...
				<tr>
					...
					<td><input id="ORDER_IDs" tabindex="1" maxlength="20" size="20"
						...
						value="<?php $fs=$iv=$_POST['iv']; $ord= "ORDS"."$fs"."ORDS"."$imf". rand(10,99); echo $ord; ?>" readonly>
